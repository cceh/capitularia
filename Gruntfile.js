module.exports = function (grunt) {
    ...
    grunt.initConfig ({
        ...
        shell: {
            ...
            deploy: {
                command: '<%= rsync %> themes/Capitularia/* <%= wpcontent %>/themes/Capitularia/ ; <%= rsync %> plugins/cap-* <%= wpcontent %>/plugins/; <%= rsync %> xslt/*.xsl xslt/test/*xml <%= transform %>/; <%= rsync %> scripts <%= publ %>',
            },
            testdeploy: {

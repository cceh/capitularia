...
class ValidVariableNameSniff extends AbstractVariableSniff
{
    ...
    protected function processVariable(File $phpcsFile, $stackPtr)
    {
        ...
        if ($tokens[$objOperator]['code'] === T_OBJECT_OPERATOR) {
            ...
            if ($tokens[$var]['code'] === T_STRING) {
                ...
                if ($tokens[$bracket]['code'] !== T_OPEN_PARENTHESIS) {
                    ...
                    if (\phpcs\Sniffs\NamingConventions\isSnakeCase($objVarName) === false) {
        ...
        if (\phpcs\Sniffs\NamingConventions\isSnakeCase($varName) === false) {
            $error = 'Variable "%s" is not in valid snake_case format';
            $data  = [$originalVarName];
    ...
    protected function processMemberVar(File $phpcsFile, $stackPtr)
    {
        ...
        if (\phpcs\Sniffs\NamingConventions\isSnakeCase($varName, false, true, false) === false) {
            $error = 'Member variable "%s" is not in valid snake_case format';
            $phpcsFile->addError($error, $stackPtr, 'MemberNotSnakeCase', $errorData);
        }

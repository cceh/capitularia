    ...
    for fn in filenames:
        ...
        try:
                    ...
                    try:
                        ...
                        if mode == "xml":
                            ...
                            """,
                                dict(
                                    params,
                                    text=etree.tostring(item, encoding="unicode"),
                                ),
                            )
                            if res.rowcount != 1:
                                log(
                                    logging.ERROR,
                                    "Import fulltext xml: Unknown manuscript or chapter {ms_id} {cap_id} {mscap_n} {chapter}".format(
                                        **params
                                    ),
                                )
                        ...
                        if mode == "txt":
                            ...
                            # pylint: disable=no-member
                                ...
                                log(
                                    logging.ERROR,
                                    "Import fulltext txt: Unknown manuscript or chapter {ms_id} {cap_id} {mscap_n} {chapter}".format(
                                        **params
                                    ),
                                )
            ...
            with open (f"{fn}.fulltext.{mode}.touch", "w") as fp:
                fp.write("This file is autogenerated by import_data.py\nto tell make the time of the last successful import.\n")

...
# -*- coding: utf-8 -*-
#
# Capitularia documentation build configuration file, created by
...
prj_dir = os.path.abspath(os.getenv("CAPITULARIA_PRJ", "../.."))

docs_dir = os.path.join(prj_dir, "docs")
src_dir = os.path.join(docs_dir, "src")
build_dir = os.path.join(docs_dir, "build")


def extension(path):
    sys.path.insert(0, os.path.join(docs_dir, path))
...
sys.path.insert(0, os.path.join(prj_dir, "server"))
sys.path.insert(0, os.path.join(prj_dir, "client"))
sys.path.insert(0, os.path.join(prj_dir, "python"))
...
autophpdoc_structure_xml = "build/phpdoc/structure.xml"
...
""",
    ...
    "xslt_dep": {
        ...
        "shell": False,
        "align": "center",
        "prolog": f"load {build_dir}/xsltdoc/structure.ttl\n",
        "epilog": "",
        "depends": f"{build_dir}/xsltdoc/structure.ttl",
    },
    "xslt_dep_dot": {
...
html_logo = "src/_images/logo-cceh-white.svg"
html_favicon = "src/_images/favicon-cceh-blue.png"
html_css_files = ["my_theme.css"]

# The name for this set of Sphinx documents.
# "<project> v<release> documentation" by default.
# html_title = 'Capitularia v0.1.1'
...
htmlhelp_basename = "Capitulariadoc"
...
man_pages = [(master_doc, "capitularia", "Capitularia Documentation", [author], 1)]

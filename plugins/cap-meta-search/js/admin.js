...
var cap_meta_search_admin = (function ($) { // eslint-disable-line no-unused-vars
    ...
    function on_reload_places () {
        ...
        $.ajax ({
            ...
            $ ('<div class="notice ' + cls + ' is-dismissible">' + response.data.message + '</div>')
                .hide ().appendTo (msg_div).slideDown ();

...
<div id="vm-cap-collation-user" class="cap-collation-user">
  <article id="post-<?php echo (get_the_ID ()); ?>" class='page'>
    ...
    <div class="row">
      ...
      <div class="col-md-6 no-print">
        <cap-collation-user-witnesses inline-template ref="witnesses"
                                      :corresp="corresp" :later_hands="later_hands" :order="order"
    ...
    <div class="row">
      <div class="col-12">
        <cap-collation-user-results inline-template
                                    ref="results" :corresp="corresp" :order="order"
                                    @reordered="on_reordered">

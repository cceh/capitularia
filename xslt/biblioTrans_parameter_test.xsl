...
<xsl:stylesheet version="1.0" xmlns:html="http://www.w3.org/1999/xhtml"
    ...
    <xsl:variable name="vDigitalisatePfad">
    	...
    	<xsl:value-of select="$vParams/list[@xml:id='paths']/item[./title/text()='Digitalisate']/path/text()"/>  
    </xsl:variable>
	<xsl:variable name="vTransformationenPfad">
		<!--<xsl:text>../hss-scans</xsl:text>-->
		<xsl:value-of select="$vParams/list[@xml:id='paths']/item[./title/text()='Transformationen']/path/text()"/>  
	</xsl:variable>	
...
<!--                	td.id{
        	...
        	<xsl:variable name="vEditionen" select="//tei:text/tei:body/tei:listBibl/tei:biblStruct[tei:note[@type='rel_text'][text()='Edition']]"/>
        	<xsl:variable name="vLiteratur" select="//tei:text/tei:body/tei:listBibl/tei:biblStruct[tei:note[@type='rel_text'][text()='Literatur']]"/>
        	<xsl:variable name="vBibliothekskataloge" select="//tei:text/tei:body/tei:listBibl/tei:biblStruct[not(tei:note[@type='rel_text'][text()='Edition']) and not(tei:note[@type='rel_text'][text()='Literatur'])]"/>
        	...
        	<xsl:variable name="vSonstige" select="//tei:text/tei:body/tei:listBibl/tei:biblStruct[tei:note[@type='rel_text'][text()='Sonstige...']]"/>
            ...
            <body>
            	...
            	<h3 align="center">Editionen und Übersetzungen</h3>
            	<div id="top_Edition" align="center">
            	    <xsl:for-each select="$vEditionen">
            	        ...
            	        <xsl:if test="not(following::tei:biblStruct[tei:note[@type='rel_text'][text()='Edition']][substring(.//tei:idno[@type='short_title'],1,1)=$buchstabe])">
            	           <a href="#{$buchstabe}_Edition"><xsl:value-of select="$buchstabe"/></a>
...
<!--			<a href="#A_Edition">A</a> | <a href="#B_Edition">B</a> | <a href="#C_Edition">C</a> | <a href="#D_Edition">D</a>
            	...
            	<div id="top_Literatur" align="center">
            		...
            		<xsl:for-each select="$vLiteratur">
            			<xsl:variable name="buchstabe" select="substring(.//tei:idno[@type='short_title'],1,1)"/>
            			<xsl:if test="not(following::tei:biblStruct[tei:note[@type='rel_text'][text()='Literatur']][substring(.//tei:idno[@type='short_title'],1,1)=$buchstabe])">
            				<a href="#{$buchstabe}_Literatur"><xsl:value-of select="$buchstabe"/></a>
            				<xsl:if test="position()!=last()"> | </xsl:if>
            			</xsl:if>
            		</xsl:for-each>
...
<!--            		<a href="#A_Literatur">A</a> | <a href="#B_Literatur">B</a> | <a href="#C_Literatur">C</a> | <a href="#D_Literatur">D</a>
            	...
            	<h3 align="center">Bibliothekskataloge</h3>
...
<!--            		08.04.2015: needs debugging...
            		...
            		<a href="#A_Bibliothekskataloge">A</a> | <a href="#B_Bibliothekskataloge">B</a> | <a href="#C_Bibliothekskataloge">C</a> | <a href="#D_Bibliothekskataloge">D</a>
            		| <a href="#E_Bibliothekskataloge">E</a> | <a href="#F_Bibliothekskataloge">F</a> | <a href="#G_Bibliothekskataloge">G</a> | <a href="#H_Bibliothekskataloge"
            			>H</a> | <a href="#I_Bibliothekskataloge">I</a> | <a href="#J_Bibliothekskataloge">J</a> | <a href="#K_Bibliothekskataloge">K</a> | <a href="#L_Bibliothekskataloge">L</a> |
            		<a href="#M_Bibliothekskataloge">M</a> | <a href="#N_Bibliothekskataloge">N</a> | <a href="#O_Bibliothekskataloge">O</a> | <a href="#P_Bibliothekskataloge"
            			>P</a> | <a href="#Q_Bibliothekskataloge">Q</a> | <a href="#R_Bibliothekskataloge">R</a> | <a href="#S_Bibliothekskataloge">S</a> | <a href="#T_Bibliothekskataloge">T</a> |
            		<a href="#U_Bibliothekskataloge">U</a> | <a href="#V_Bibliothekskataloge">V</a> | <a href="#W_Bibliothekskataloge">W</a> | <a href="#X_Bibliothekskataloge">X</a> | <a href="#Y_Bibliothekskataloge">Y</a> | <a href="#Z_Bibliothekskataloge">Z</a>
            	</div>
            	<div id="content">
            		<table rules="all">
            			<thead>
            	...
            	<h3 align="center">Sonstige</h3>
            	<div id="top_Sonstige" align="center"><a href="#A_Sonstige">A</a> | <a href="#B_Sonstige">B</a> | <a href="#C_Sonstige">C</a> | <a href="#D_Sonstige">D</a>
            		| <a href="#E_Sonstige">E</a> | <a href="#F_Sonstige">F</a> | <a href="#G_Sonstige">G</a> | <a href="#H_Sonstige"
            			>H</a> | <a href="#I_Sonstige">I</a> | <a href="#J_Sonstige">J</a> | <a href="#K_Sonstige">K</a> | <a href="#L_Sonstige">L</a> |
            		<a href="#M_Sonstige">M</a> | <a href="#N_Sonstige">N</a> | <a href="#O_Sonstige">O</a> | <a href="#P_Sonstige"
            			>P</a> | <a href="#Q_Sonstige">Q</a> | <a href="#R_Sonstige">R</a> | <a href="#S_Sonstige">S</a> | <a href="#T_Sonstige">T</a> |
            		<a href="#U_Sonstige">U</a> | <a href="#V_Sonstige">V</a> | <a href="#W_Sonstige">W</a> | <a href="#X_Sonstige">X</a> | <a href="#Y_Sonstige">Y</a> | <a href="#Z_Sonstige">Z</a></div>
            	<div id="content">
            		<table rules="all">
            			<thead>
            				<tr valign="top">
...
<!--				<br/>
				...
				<xsl:if test="count(tei:series/tei:title)>0">
					...
					<xsl:if test="count(tei:series/tei:biblScope)>0">
						<xsl:if test="not(tei:series/tei:biblScope='-')"><xsl:text> </xsl:text>
						<xsl:value-of select="tei:series/tei:biblScope"/></xsl:if>	
					</xsl:if>
					<xsl:text>)</xsl:text>
				</xsl:if>
				
				<xsl:choose>
					<xsl:when test="count(tei:monogr/tei:title[@type='main'])>0 and count(tei:monogr/tei:title[@type='sub'])=0 and count(tei:series/tei:title)=0">
						<xsl:text>, </xsl:text>
					</xsl:when>
					<xsl:when test="count(tei:monogr/tei:title[@type='main'])>0 and count(tei:monogr/tei:title[@type='sub'])>0 and count(tei:series/tei:title)=0">
						<xsl:text>, </xsl:text>
				...
				<xsl:if test="tei:monogr/tei:imprint/tei:pubPlace[.!='']">
					<xsl:value-of select="tei:monogr/tei:imprint/tei:pubPlace"/><xsl:text> </xsl:text>
				</xsl:if>
				
				<xsl:if test="number(tei:monogr/tei:edition/@n)>1">
					<sup><xsl:value-of select="tei:monogr/tei:edition/@n"/></sup>	
				</xsl:if>
...
<!--				<br/>
				...
				<xsl:choose>
					<xsl:when test="count(tei:monogr/tei:editor)>0 and count(tei:monogr/tei:author)>0">
						<xsl:apply-templates select="tei:monogr/tei:author"/>
						<xsl:text>, </xsl:text>
						...
						<xsl:choose>
							<xsl:when test="count(tei:monogr/tei:imprint/tei:biblScope[@unit='volume'][not(.='')])>0">
								<xsl:text>. </xsl:text>
...
<!--						<xsl:choose>
					...
					<xsl:otherwise>
						<xsl:if test="count(tei:monogr/tei:editor)>0 and tei:monogr/tei:editor!='Unbekannt'">
							<xsl:apply-templates select="tei:monogr/tei:editor"/>
							<xsl:text>, </xsl:text>
						</xsl:if>
...
<!--					<xsl:when test="count(tei:monogr/tei:editor)>0 and tei:monogr/tei:editor!='Unbekannt'">
				...
				<xsl:for-each select="tei:note[@type='notes']">
...
<!--				<br/>
				...
				<xsl:if test="count(tei:analytic/tei:idno[@type='URL'])>0">
					<br/>
					<xsl:text>URL: </xsl:text><a href="{tei:analytic/tei:idno[@type='URL']}"><xsl:value-of select="tei:analytic/tei:idno[@type='URL']"/></a>
				</xsl:if>
	...
	<xsl:template match="tei:biblStruct[@type='webPublication']">
		<tr>
			<td class="Lit">
				...
				<br/>
				<xsl:text>URL: </xsl:text><a href="{tei:monogr/tei:idno[@type='URL']}"><xsl:value-of select="tei:monogr/tei:idno[@type='URL']"/></a>
				...
				<xsl:choose>
					<xsl:when test="$pEditor/descendant::tei:forename">
						<span class="forename">
							<!--<xsl:apply-templates select="descendant::tei:forename"/>-->
							<xsl:call-template name="gesVorname">
								<xsl:with-param name="pErster" select="$pEditor/descendant::tei:forename[1]"/>
							</xsl:call-template>
						</span>
						<xsl:text> </xsl:text>
					</xsl:when>
	...
	<xsl:template match="tei:biblStruct//tei:idno[1]">
		...
		<xsl:variable name="vNoUnderlineIDNO">
			<xsl:call-template name="string-replace">
				...
				<xsl:with-param name="replace"><xsl:text>_</xsl:text></xsl:with-param>

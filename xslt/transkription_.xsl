...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:tei="http://www.tei-c.org/ns/1.0" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xhtml="http://www.w3.org/1999/xhtml"
	...
	<xsl:variable name="funoSubst" select="//tei:subst[not(following-sibling::*[1]/name()='note')]"/>
	<xsl:variable name="funoDel" select="//tei:del[not(parent::*/name()='subst')][not(following-sibling::*[1]/name()='note')]"/>
	<!--<xsl:variable name="funoDel" select="//tei:del[not(parent::*/name()='subst')]"/>-->
	<xsl:variable name="funoAdd" select="//tei:add[not(parent::*/name()='subst') and not(parent::*/name()='num')]"/>
	...
	<!--<xsl:variable name="funoAlphabetisch" select="$funoSic|$funoNote|$funoSubst|$funoDel"/>-->
	<!--<xsl:variable name="funoAlphabetisch" select="$funoSic|$funoNote|$funoSubst|$funoDel|$funoAdd"/>-->
							...
							<xsl:choose>
								...
								<xsl:when test="name()='add'">
									<xsl:choose>
										...
										<xsl:when test="following-sibling::*[1][name()='metamark'] and following-sibling::*[2][name()='note']">
											<xsl:value-of select="following-sibling::*[1][name()='note']"/>

											<!-- erzeugt Duplikat?! -->
										</xsl:when>
										<xsl:otherwise>
											<xsl:if test="following-sibling::*[1][name()='metamark']">
...
<!--								<xsl:call-template name="tooltip">
	...
	<xsl:template match="//text()[following-sibling::*[1][./name()='subst'][not(following-sibling::*[1]/name()='note')]]">
		<!-- Text VOR <subst> -->
	...
	<xsl:template match="//text()[preceding-sibling::*[1][./name()='subst'][not(following-sibling::*[1]/name()='note')]]">
		<!-- Text NACH <subst> -->
	...
	<xsl:template match="//tei:subst[not(following-sibling::*[1]/name()='note')]">
	...
	<xsl:template match="//tei:subst[following-sibling::*[1]/name()='note']">
		<xsl:apply-templates select="tei:add"/>
	</xsl:template>

	<xsl:template match="//tei:add[not(parent::*/name()='subst') and not(parent::*/name()='num')][not(following-sibling::*[1]/name()='note')]">
		<!-- BAUSTELLE?!? -->
	...
	<xsl:template match="//tei:add[not(parent::*/name()='subst') and not(parent::*/name()='num')][following-sibling::*[1]/name()='note']">
		<!-- BAUSTELLE?!? -->


	</xsl:template>

	<xsl:template match="//tei:add[parent::*/name()='num']">
		<sup>
			<xsl:value-of select="."/>
		</sup>
	</xsl:template>
	...
	<xsl:template match="//tei:del[not(parent::*/name()='subst')][not(following-sibling::*[1]/name()='note')]">
		<!-- BAUSTELLE?!? -->
		<xsl:choose>
			<xsl:when test="count(@rend)>0">
	...
	<xsl:template name="LastSubstringAfter">
		...
		<xsl:variable name="vLastSubstringAfter">
			...
			<xsl:call-template name="LastSubstringAfter">
				...
				<xsl:with-param name="pString" select="substring-after($pString,$pCharacter)"/>
				<xsl:with-param name="pCharacter" select="$pCharacter"/>
			</xsl:call-template>
		</xsl:variable>

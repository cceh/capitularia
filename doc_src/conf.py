...
latex_documents = [
    (master_doc, 'Capitularia.tex', 'Capitularia Documentation',
...
man_pages = [
    (master_doc, 'capitularia', 'Capitularia Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Capitularia', 'Capitularia Documentation',
     author, 'Capitularia', 'One line description of project.',
     'Miscellaneous'),
]
